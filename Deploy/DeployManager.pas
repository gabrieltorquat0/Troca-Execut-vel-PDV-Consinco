...
var SI: TStartupInfo; PI: TProcessInformation; ExitCode: Cardinal;
begin
  ZeroMemory(@SI, SizeOf(SI)); SI.cb := SizeOf(SI);
  Result := CreateProcess( nil, PChar(Cmd), nil, nil, False, CREATE_NO_WINDOW, nil, nil, SI, PI );
  if Result then
    begin WaitForSingleObject(PI.hProcess, INFINITE);
